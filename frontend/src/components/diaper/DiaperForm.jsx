    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-3">
      ...
      <div>
        ...
        <input
          ...
          className="w-full min-w-0 max-w-full appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
        />
      </div>
